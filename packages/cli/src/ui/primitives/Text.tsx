...
type RichMarkupTag =
  'blink' | 'dim' | 'highlight' | 'strong' | RichToneTag | RichSizeTag
...
export type TextFitType =
  'ellipsis' | 'clipped' | 'autofit' | 'hidden' | 'shrink'
...
export interface TextProps {
  ...
  weight?:
    'normal' | 'semibold' | 'bold' | 'light' | 'thin' | 'extralight' | 'black'
}
...
export function textBase(props: TextProps): ReactElement {
  ...
  const composedStyle: CSSProperties = {
    ...(props.style ?? {}),
    ...(props.fontStack !== undefined ? { fontFamily: props.fontStack } : {}),
  }
