...
const assets = {
  ...
  "emoji-berry.svg": fileURLToPath(new URL("../assets/emoji-berry.svg", import.meta.url)),
  "emoji-coffee.svg": fileURLToPath(new URL("../assets/emoji-coffee.svg", import.meta.url)),
  "emoji-cool.svg": fileURLToPath(new URL("../assets/emoji-cool.svg", import.meta.url)),
  "emoji-fire.svg": fileURLToPath(new URL("../assets/emoji-fire.svg", import.meta.url)),
  "emoji-grin.svg": fileURLToPath(new URL("../assets/emoji-grin.svg", import.meta.url)),
  "emoji-joy.svg": fileURLToPath(new URL("../assets/emoji-joy.svg", import.meta.url)),
  "emoji-leaf.svg": fileURLToPath(new URL("../assets/emoji-leaf.svg", import.meta.url)),
  "emoji-party.svg": fileURLToPath(new URL("../assets/emoji-party.svg", import.meta.url)),
  "emoji-pizza.svg": fileURLToPath(new URL("../assets/emoji-pizza.svg", import.meta.url)),
  "emoji-rainbow.svg": fileURLToPath(new URL("../assets/emoji-rainbow.svg", import.meta.url)),
  "emoji-sushi.svg": fileURLToPath(new URL("../assets/emoji-sushi.svg", import.meta.url)),
  "emoji-wave.svg": fileURLToPath(new URL("../assets/emoji-wave.svg", import.meta.url)),
...
function getEmojiFallbackLabel(emoji: string): string {
  ...
  const codePoints = Array.from(emoji, (symbol) => symbol.codePointAt(0)?.toString(16).toUpperCase())
...
const emojiEntryButton = {
  ...
  createInstance: ({ button, config, methods }: {
    ...
    render: () => createElement("deck-button", {
      ...(EMOJI_ICON_ASSETS[config.emoji] !== undefined ? { icon: EMOJI_ICON_ASSETS[config.emoji] } : {}),
      keyIndex: button.position,
      label: getEmojiFallbackLabel(config.emoji),
      subtitle: config.label,
      ...(EMOJI_ICON_ASSETS[config.emoji] === undefined ? { variant: "emoji" as const } : {}),
    }),
  }),
