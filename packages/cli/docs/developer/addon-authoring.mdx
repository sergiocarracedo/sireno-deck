...
```typescript
// manifest.ts
import type { AddonManifestV1 } from "@sirenodeck/sirenodeck"
...
import type { AddonFrontendButtonProps } from "@sirenodeck/sirenodeck"
...
```typescript
// backend.ts
import type { AddonButtonTypeService } from "@sirenodeck/sirenodeck"
