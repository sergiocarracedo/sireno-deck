// ponytail: stub for `@sirenodeck/sirenodeck/ui/primitives/Label`. The daemon loads the addon's
...
// resolves `@sirenodeck/sirenodeck/ui/primitives/Label` to the real host component and ignores
