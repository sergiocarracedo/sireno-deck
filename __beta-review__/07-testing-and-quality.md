...
### [x] [07-testing-and-quality #3] [P0] `pnpm lint` fails (4 errors)
...
### [x] [07-testing-and-quality #4] [P0] Coverage excludes SPA, .tsx, and most UI files
...
### [x] [07-testing-and-quality #5] [P0] No CI workflow
