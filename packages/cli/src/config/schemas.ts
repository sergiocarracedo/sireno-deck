...
export const UserDeckCreateSchema = z
  .object({
    id: z.string().min(1),
    name: z.string().min(1).optional(),
    icon: IconSourceSchema.optional(),
...
export const UserDeckUpdateSchema = z
  .object({
    name: z.string().min(1).optional(),
    icon: IconSourceSchema.nullable().optional(),
...
export type UserDeckCreate = z.infer<typeof UserDeckCreateSchema>
export type UserDeckUpdate = z.infer<typeof UserDeckUpdateSchema>
