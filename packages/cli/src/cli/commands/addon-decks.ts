...
const mapAddonDeckToRuntimeDeck = (id: string, gdeck: AddonGeneratedDeck): RuntimeDeck => {
...
export const materializeAddonDecks = (
  ...
  const addonConfigs = collectAddonDefaultButtonConfig(registry, userDecks, logger);
