  ...
  it('loads optional theme ui presentation overrides from a custom theme package', async () => {
    ...
    writeFileSync(
      ...
      [
        ...
        'export const ui = {',
        '  chip(props) {',
        '    return cloneElement(props.children, { "data-custom-chip": props.tone })',
        '  },',
        '  icon(props) {',
        '    return cloneElement(props.children, { "data-custom-icon": props.source })',
        '  },',
        '  text(props) {',
        '    return cloneElement(props.children, { "data-custom-text": props.fit })',
        '  },',
        '}',
