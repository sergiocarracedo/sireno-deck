...
### [02-architecture #1] [P0] Token optional in protocol schema
...
### [02-architecture #2] [P0] `core:next-page` declared but has no handler
...
### [02-architecture #3] [P0] `addon-handler-bridge.ts` hot-reload leaks old addon services
...
### [02-architecture #4] [P0] `runtime.ts` is a god object (890 LoC, 20+ closure vars)
