...
### [05-frontend-ui #1] [P0] `Text.test.tsx` is red (`5xl` maps to `14`, test expects `48`)
...
### [05-frontend-ui #2] [P0] `ws-integration.test.tsx` is an empty placeholder
...
### [05-frontend-ui #3] [P0] Frontend `Deck.tsx` does not pass `addonName` to addon components
...
### [05-frontend-ui #4] [P0] Frontend `Deck.tsx` passes pointer handlers that `ButtonFrame` drops
...
### [05-frontend-ui #5] [P0] Manual dbl-click in `Deck.tsx` emits `tap` then `dbl-tap`
**Evidence:** Same file.
...
### [05-frontend-ui #6] [P0] Both `App.tsx` files unconditionally re-render every 250ms
