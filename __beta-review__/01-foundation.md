...
### [01-foundation #3] [P0] Token is not enforced in the production WS bridge
...
### [01-foundation #4] [P0] Token is not propagated to Vite children
...
### [01-foundation #5] [P0] `packages/cli/src/index.ts` violates process boundary
...
### [01-foundation #6] [P0] Version constants contradict each other across files
...
### [01-foundation #7] [P0] `service-manager.ts` imports a non-existent module
