...
updated: 2026-05-17T12:25:00+02:00
---

## Current Test
number: 1
name: lock-aware switching and restore
expected: |
  Review the committed Phase 11 lock fixture and confirm the runtime shows the normal navigation path before lock, swaps to the configured locked surface during lock, and restores the exact prior navigation state after unlock.
