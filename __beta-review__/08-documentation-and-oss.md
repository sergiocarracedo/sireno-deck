...
### [x] [08-documentation-and-oss #1] [P0] No `LICENSE` at repository root
...
### [x] [08-documentation-and-oss #2] [P0] `README.md` references wrong package name
...
### [x] [08-documentation-and-oss #3] [P0] `README.md` button-type examples are obsolete
...
### [x] [08-documentation-and-oss #4] [P0] `README.md` mentions a production build path that doesn't exist
...
### [x] [08-documentation-and-oss #5] [P0] `README.md` links to non-existent paths
